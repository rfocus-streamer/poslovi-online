            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fas fa-credit-card text-danger"></i> <strong>Rezervisana sredstva:</strong> {{ number_format(($project->reserved_funds + $project->commission->buyer_amount), 2) }} €</li>
                    </ul>
                </div>
            </div>
        </div>
