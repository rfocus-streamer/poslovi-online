            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fas fa-credit-card text-danger"></i> <strong>Rezervisana sredstva:</strong> {{ number_format(($project->reserved_funds - $project->commission->amount * 0.10), 2) }} €</li>
                    </ul>
                </div>
            </div>
        </div>
