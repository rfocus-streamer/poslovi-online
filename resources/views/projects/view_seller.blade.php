            ...
            <div class="card">
                <div class="card-body">
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fas fa-credit-card text-danger"></i> <strong>Rezervisana sredstva:</strong> {{ number_format(($project->reserved_funds * (1 - ($project->commission[0]->seller_percentage / 100))), 2) }} €</li>
                    </ul>
                </div>
            </div>
        </div>
